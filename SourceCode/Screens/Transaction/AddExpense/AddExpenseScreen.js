          ...
          <MainHeaderContainer >
              <MainHeaderLeft>
                <TouchableOpacity 
                  ...
                  >
                  <FontAwesome style={{color:'#ffffff',fontSize:20}} icon={SolidIcons.chevronCircleLeft} />
                 
                </TouchableOpacity>
              </MainHeaderLeft>
              <MainHeaderMid>
              <Caption style={{ fontSize:20,color:'#ffffff',padding:3}}>ADD Expense</Caption>
              </MainHeaderMid>
              <MainHeaderRight>
                  ...
                  <TouchableOpacity style={{right:5}} onPress={this.props.onPressYearUP}>
                      <FontAwesome style={{color:'#ffffff',fontSize:30}} icon={SolidIcons.checkCircle} />
                  </TouchableOpacity>
              </MainHeaderRight>
          </MainHeaderContainer>
      );
        ...
        return(
          <MainLayout navigation={this.props.navigation}  header={<MainHeader navigation={this.props.navigation} onPressYearUP={this.onPressYearUP}/>}>
            ...
            <Body>
              ...
              <Row>
                <RowLeft>
                  <FontAwesome style={{color:'#563469',fontSize:20}} icon={SolidIcons.calendarAlt} />
                </RowLeft>
                <RowRight>
                  <TextBox />
                </RowRight>
              ...
              <Row>
                <RowLeft>
                  <FontAwesome style={{color:'#563469',fontSize:20}} icon={SolidIcons.wineGlass} />
                </RowLeft>
                <RowRight>
                  <TextBox />
                </RowRight>
